...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mopro_example_app_checksum_func_generate_circom_proof() != 10144) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_checksum_func_generate_halo2_proof() != 51520) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_checksum_func_generate_noir_proof() != 54298) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_checksum_func_get_noir_verification_key() != 38748) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_checksum_func_mopro_uniffi_hello_world() != 57387) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_checksum_func_verify_circom_proof() != 52175) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_checksum_func_verify_halo2_proof() != 142) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_mopro_example_app_checksum_func_verify_noir_proof() != 40491) {
        return InitializationResult.apiChecksumMismatch
    }
